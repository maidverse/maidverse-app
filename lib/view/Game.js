...
class Game {
    constructor() {
        ...
        this.screen.root.append(this.socialButton = new SocialPanel_1.default(), this.world = new World_1.default());
        this.repositeUI();
    ...
    async checkDiscordLogin() {
        ...
        if (code === undefined) {
            ...
            this.screen.root.append(new Enter_1.default(false));
        }
        else {
            try {
    ...
    async checkWalletConnected() {
        if (await Wallet_1.default.connected() !== true) {
            this.screen.root.append(new Enter_1.default(true));
        }
        else {
    ...
    async loadUserPanel(address) {
        this.screen.root.append(this.userPanel = new UserPanel_1.default());
        this.repositeUI();
