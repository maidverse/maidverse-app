...
class InitMaidPopup extends skyengine_1.GameNode {
    constructor() {
        super(0, 0);
        this.dom = (0, skynode_1.el)(".popup-background", (0, skynode_1.el)(".init-maid-popup", (0, skynode_1.el)("h1", "Select maid avatar"), this.content = (0, skynode_1.el)(".content")));
    ...
    async loadMaids() {
        ...
        if (all.ethereum.length === 0) {
            ...
            this.content.empty().append((0, skynode_1.el)(".avatars-wrapper", list), continueButton);
        }
    }
}
exports.default = InitMaidPopup;
//# sourceMappingURL=InitMaidPopup.js.map