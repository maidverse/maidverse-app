...
class SelectMaidPopup extends skyengine_1.GameNode {
    constructor() {
        super(0, 0);
        this.dom = (0, skynode_1.el)(".popup-background", (0, skynode_1.el)(".select-maid", (0, skynode_1.el)("h1", "Select maid avatar"), this.content = (0, skynode_1.el)(".content"), (0, skynode_1.el)("footer", (0, skynode_1.el)("a.close-button", "Close", {
            click: () => this.delete(),
        }))));
