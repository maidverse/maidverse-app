...
class Enter extends skyengine_1.GameNode {
    constructor(discordAuthed) {
        ...
        this.dom = (0, skynode_1.el)(".popup-background", this.dom = (0, skynode_1.el)(".enter", (0, skynode_1.el)("header", (0, skynode_1.el)("h1", "Welcome"), (0, skynode_1.el)("p", "Discord login is required to enter Maidverse.")), this.content = (0, skynode_1.el)(".content"), (0, skynode_1.el)("footer", this.continueButton = (0, skynode_1.el)("a.continue-button", "Continue", {
            click: async () => {
                if (this.steps === 1) {
